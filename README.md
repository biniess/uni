...
[ERD](https://github.com/biniess/uni/blob/main/doc/%D0%91%D0%94.jpg)

Диаграмма сущностей и связей (ERD) для базы данных включает несколько ключевых сущностей, таких как Пользователь (User), Санаторий (Sanatorium), Бронирование санатория (Booking), Отзывы (Review), Медицинские записи (Medical records), Доктор (Doctors) и Медицинские услуги (Medical service). Эти сущности и их атрибуты обеспечивают основные функции веб-приложения для управления санаторием. Каждая сущность имеет свои атрибуты, включая уникальные идентификаторы, которые служат первичными ключами (PK), и другие атрибуты, хранящие различные данные.
